...
if (active && payload && payload.length) {
    ...
    <Card className="bg-background border-primary">
        ...
        <p className="font-semibold">Distance to Downtown: {payload[0].value.toFixed(2)}</p>
...
export const HotelScatterPlot: React.FC<ScatterPlotProps> = ({ data }) => {
...
return (
    ...
    >
        ...
        tickCount={6}
        label={{ value: 'Distance to Downtown', position: 'bottom', offset: 0 }}
        />
        <YAxis
        type="number"
        dataKey="x"
